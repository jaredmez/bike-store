...
function Header(props) {
    ...
    const cartCount = props.cart.reduce((prev, itm) => {
        return prev + itm.qty;
    }, 0);
    
    const subTotal = props.cart.reduce((prev, itm) => {
        return prev + (itm.price * itm.qty);
    }, 0);
            ...
            <div className="main-nav">
                ...
                <div className="cart-ctn">
                    ...
                    <div className="cart-logo-bttn" onClick={showCartDrawer}>
                        <p style={{visibility: cartCount === 0 ? 'hidden' : 'visible'}}>{cartCount}</p>
                ...
                <div className="cart-display">
                    ...
                    {props.cart.map(item => 
                        <div className="cart-drawer-item">
                            ...
                            <p style={{textAlign: 'right', marginRight:'40px'}}>{item.price} x {item.qty}</p>
                        </div>
                        )}
                </div>
